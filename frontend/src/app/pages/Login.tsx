      ...
      <div className="flex-1 flex items-center justify-center px-6 py-20">
        ...
        >
            ...
            <form className="space-y-6">
                ...
                <button 
                    type="button" 
                    className="w-full bg-white text-purple-900 font-bold py-3.5 rounded-full hover:bg-purple-100 transition-all hover:scale-[1.02] active:scale-[0.98] shadow-lg shadow-black/20 mt-2 cursor-pointer"
                >
                    Log In
                </button>
            </form>
            ...
            <div className="mt-8 text-center text-sm text-purple-200/60">
                ...
                <a href="#" className="text-white font-medium hover:underline hover:text-purple-200 transition-colors">Sign up</a>
            </div>
        </motion.div>
      </div>
    </div>
