...
// For SSE endpoints. The browser's EventSource API cannot set custom headers,
// so the JWT rides in the query string (`?token=...`) instead of Authorization.
...
module.exports.authFromQuery = authFromQuery;
